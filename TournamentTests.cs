    ...
    public class TournamentTests
    {
        ...
        public void CreateTournoi_Should_Return_10Matchs()
        {
            ...
            List<Player> players = new List<Player>()
            {
                ...
                new Player(){ID=2, Firstname = "Alexandra",Lastname="François",Telephone=""},
                new Player(){ID=3, Firstname = "Jeremy",Lastname="François",Telephone=""},
                ...
                new Player(){ID=10, Firstname = "Noémie",Lastname="Riquier",Telephone=""},
